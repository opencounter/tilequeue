...
def explode_and_intersect(
        coord_ints, tiles_of_interest, intersect_metrics, until=0):
    ...
    while True:
        ...
        if not coord_ints_at_parent_zoom:
            intersect_metrics['total'] = total
            intersect_metrics['hits'] = hits
            intersect_metrics['misses'] = misses
            return
...
def tilequeue_intersect(cfg, peripherals):
    ...
    intersect_metrics = {}
    coord_ints = explode_and_intersect(
        all_coord_ints_set, tiles_of_interest, intersect_metrics,
